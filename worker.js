...
<title>JadeKey — Collectors</title>
...
<div class="content">
  <h1>Collectors</h1>
  <div class="sub">${Object.keys(clients).length} registered · JadeKey</div>
...
<nav>
  <a href="/" class="logo">JADE<em>KEY</em></a>
  <a href="/clients" class="back">← Collectors</a>
</nav>
<div class="header">
...
function passportPage(id, w) {
  const tonBlock = w.ton_tx ? [
    ...
    '<div style="font-family:Space Mono,monospace;font-size:9px;color:#6b5f4e">' + (w.ton_anchored_at || '2026-05-30') + ' &middot; Immutable proof of authenticity</div>',
    '</div>',
...
<div style='background:#8b2218;color:#f2ece0;padding:20px 40px;display:flex;justify-content:space-between;align-items:center;'>
  <div>
    <div style='font-family:Space Mono,monospace;font-size:10px;letter-spacing:.3em;margin-bottom:6px'>FOR SALE</div>
    <div style='font-size:28px;font-weight:300'>${w.price_ton} TON</div>
  </div>
  <a href='ton://transfer/UQCSHtvmlLI8uWI0SpP0Nuwbf5Yth4MrW9sPhwW7jnyBEKCu?amount=${w.price_ton*1000000000}&text=JadeKey:${id}' style='background:#f2ece0;color:#8b2218;padding:14px 28px;text-decoration:none;font-family:Space Mono,monospace;font-size:11px;letter-spacing:.2em;'>BUY →</a>
</div>
` : ''}
...
<div class="agate-section">
  ...
  <div class="agate-info">
    ...
    <div class="agate-subtitle">AGATE CROSS-SECTION · PHYSICALLY UNCLONABLE FUNCTION</div>
    ...
    <div class="hash-block">
      ...
      <div class="hash-val">${id} · Verified and registered · jadekey.art</div>
